	...
	tests := []struct {
	...
	}{
		{
			...
			setUCaseExpectations: func(session *domain.Session, uCase *mocks.AuthUsecase) {
				...
				uCase.On("Email", mock.Anything).Return(*session, 1, nil)
			},
		...
		},
		{
			...
			setUCaseExpectations: func(session *domain.Session, uCase *mocks.AuthUsecase) {
				*session = domain.Session{}
				uCase.On("Email", mock.Anything).Return(*session, 0, domain.ErrWrongCredentials).Maybe()
			},
		...
		},
		{
			...
			setUCaseExpectations: func(session *domain.Session, uCase *mocks.AuthUsecase) {
				...
				uCase.On("Email", mock.Anything).Return(*session, 0, nil).Maybe()
			},
		...
		},
		{
			...
			setUCaseExpectations: func(session *domain.Session, uCase *mocks.AuthUsecase) {
				...
				uCase.On("Email", mock.Anything).Return(*session, 1, nil).Maybe()
			},
			status:     http.StatusOK,
			wantCookie: true,
			auth:       userID,
		...
		},
		{
			...
			setUCaseExpectations: func(session *domain.Session, uCase *mocks.AuthUsecase) {
				*session = domain.Session{}
				...
				uCase.On("IsAuth", mock.Anything).Return("", nil).Maybe()
				uCase.On("Email", mock.Anything).Return(*session, 0, domain.ErrNotFound)
			},
	...
	tests := []struct {
		...
		},
		{
			...
			setUCaseExpectations: func(uCase *mocks.AuthUsecase, session *domain.Session) {
				...
				uCase.On("Email", mock.Anything).Return(*session, 1, domain.ErrWrongCredentials).Maybe()
			},
			status: http.StatusBadRequest,
		},
		{
			...
			setUCaseExpectations: func(uCase *mocks.AuthUsecase, session *domain.Session) {
				uCase.On("Register", mock.Anything).Return(0, nil).Maybe()
				uCase.On("Email", mock.Anything).Return(*session, 1, domain.ErrBadRequest).Maybe()
			},
			status: http.StatusBadRequest,
		},
		{
