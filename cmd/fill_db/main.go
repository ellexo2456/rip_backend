...
func main() {
	...
	alpinists := []*ds.Alpinist{
		&ds.Alpinist{
			...
			Country:     "Италия",
			ImageRef:    "http://localhost:9000/peak/1/messner.png",
			ImageName:   "1/messner.png",
		...
		&ds.Alpinist{
			...
			Country:     "Польша",
			ImageRef:    "http://localhost:9000/peak/2/kukuczka.png",
			ImageName:   "2/kukuczka.jpg",
		...
		&ds.Alpinist{
			...
			Country:     "Швейцария",
			ImageRef:    "http://localhost:9000/peak/3/erhard.jpeg",
			ImageName:   "3/erhard.jpeg",
